...
No threading or multiprocessing: all work is Spark DataFrame operations on the
driver/executors, so this module does not spawn non-daemon threads that would
block process exit after spark.stop().
