...
No threading or multiprocessing: API mode uses synchronous requests.get();
generate mode delegates to data_generator. No non-daemon threads are spawned
that would block process exit after spark.stop().
